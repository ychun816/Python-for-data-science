...
def main():
    ...
    # Define a small function for readability
    def is_longer(w):
        return len(w) > N
...
# -> ft_filter -> the function you defined (your custom version of
#    Python's built-in filter())
# -> is_longer(arg1) -> another function, passed as data (not called
#    yet!)
