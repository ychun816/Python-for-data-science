...
# NOTES ###
    ...
    # Convenience method (commented-out example): print the full table
    # without pandas truncation. To enable, uncomment this method.
    #
    # def full(self, show_index: bool = False) -> None:
    #     """Print the full underlying DataFrame without truncation.
    #
    #     This temporarily sets pandas display options to show all rows and
    #     columns, prints the DataFrame (using ``to_string``) and restores
    #     the previous pandas options.
    #     """
    #     import pandas as _pd
    #     # save current options
    #     old_max_rows = _pd.get_option('display.max_rows')
    #     old_max_cols = _pd.get_option('display.max_columns')
    #     try:
    #         _pd.set_option('display.max_rows', None)
    #         _pd.set_option('display.max_columns', None)
    #         print(self._df.to_string(index=show_index))
    #     finally:
    #         _pd.set_option('display.max_rows', old_max_rows)
    #         _pd.set_option('display.max_columns', old_max_cols)


# ---------------------------------------------------------------------------
# tester.py (copied here for convenience)
#
...
#
# v = load("life_expectancy_years.csv")  # returns DatasetView by default
# df = v.raw()                             # get the pandas DataFrame
...
# # load_csv.py), you can simply call:
# # v.full()
#
# Short explanation of tester.py and how to get full data
#
# - Run the tester script to see the compact preview printed by load().
# - To operate on the dataset, call ``v = load(...); df = v.raw()`` or
#   request the raw DataFrame: ``load(..., preview=False)``.
# - The function returns ``None`` for missing/wrong files or read errors.
#
# ---------------------------------------------------------------------------
