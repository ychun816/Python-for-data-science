...
# In Python, every function should have a docstring (a short description inside triple quotes).
...
# triple quotes -> official documentation strings (docstrings) -> function’s or module’s description
...
# if __name__ == "__main__":
#     main()
# -> telling Python: “This file can run independently (standalone), not just be imported by another script.”
